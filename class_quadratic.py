#place this code in a folder called quadtratic
...
tells the program that the code inside is this
if statement should only be executed if the 
prgoram is executed as a stnadalone program.
It will not ber executed if the program is imported as a module
"""
